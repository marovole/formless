...
const FeatureCard = ({
  ...
  >
    ...
    <div className="relative z-10">
      ...
      <h3 className="font-serif text-xl text-ink-800 mb-3 tracking-wide group-hover:text-sandalwood-800 transition-colors">
        {title}
      </h3>
    ...
    <div className="min-h-screen bg-rice-50 text-ink-800 font-sans selection:bg-sandalwood-200 selection:text-ink-900 overflow-x-hidden">
      ...
      <main>
        <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-6 overflow-hidden">
          ...
          <div
            className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-amber-50/40 rounded-full blur-3xl animate-float opacity-60 pointer-events-none"
          ...
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce opacity-30" aria-hidden>
        ...
        <section className="py-24 bg-white/50 border-y border-stone-100/50">
          <div className="container mx-auto px-6 text-center max-w-3xl">
            <div className="mb-8 flex justify-center text-sandalwood-400">
              <Leaf className="w-8 h-8 opacity-50" aria-hidden />
            </div>
        ...
        <section id="features" className="py-16 md:py-32 relative">
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center max-w-2xl mx-auto mb-12 md:mb-20">
              ...
              <p className="text-ink-500 font-light text-base md:text-lg">{tLanding('features.description')}</p>
            </div>
          ...
          <div className="max-w-5xl mx-auto bg-ink-900 rounded-2xl md:rounded-3xl p-8 md:p-12 lg:p-24 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 space-y-8">
              <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-rice-50 leading-tight">
                {tLanding('cta.title')}{' '}
                <span className="text-amber-200/80 italic">{tLanding('cta.titleHighlight')}</span>?
              </h2>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-8 text-sm text-stone-500">
              ...
              <Link href="/settings" className="hover:text-ink-800 transition-colors">
