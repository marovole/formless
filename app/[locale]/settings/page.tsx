...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-50 to-stone-100 p-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-serif text-stone-800">{t('title')}</h1>
        ...
        <div className="space-y-6">
          <Card className="p-6 border-stone-200/60">
            <div className="space-y-2 mb-4">
              <h2 className="text-lg font-semibold text-stone-800">{t('accountTitle')}</h2>
              <p className="text-xs text-stone-400">{t('accountSubtitle')}</p>
            </div>
          ...
          <Card className="p-6 border-stone-200/60">
            <div className="space-y-2 mb-4">
              <h2 className="text-lg font-semibold text-stone-800">{t('languageTitle')}</h2>
              <p className="text-xs text-stone-400">{t('languageSubtitle')}</p>
            </div>
          ...
          <Card className="p-6 border-stone-200/60">
            <div className="space-y-2 mb-4">
              <h2 className="text-lg font-semibold text-stone-800">{t('actionsTitle')}</h2>
              <p className="text-xs text-stone-400">{t('actionsSubtitle')}</p>
            </div>
